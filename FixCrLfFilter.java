...
public final class FixCrLfFilter extends BaseParamFilterReader implements ChainableReader {
    ...
    private boolean javafile = false;
    ...
    public Reader chain(final Reader rdr) {
        try {
            ...
            newFilter.setJavafiles(getJavafile());
    ...
    private static class SimpleFilterReader extends Reader {
        ...
        private int[] preemptArray = new int[PREEMPT_BUFFER_LENGTH];
        ...
        public void push(int c) {
            try {
                preemptArray[preemptIndex++] = c;
            } catch (ArrayIndexOutOfBoundsException e) {
                int[] p2 = new int[preemptArray.length * 2];
                System.arraycopy(preemptArray, 0, p2, 0, preemptArray.length);
                preemptArray = p2;
                push(c);
            }
        }
        ...
        public int read() throws java.io.IOException {
            return preemptIndex > 0 ? preemptArray[--preemptIndex] : in.read();
        }
