...
//      s++;
    ...
    private static final int dtoaMode[] = {
        0,   /* DTOSTR_STANDARD */
    ...
    JS_dtostr(StringBuilder buffer, int mode, int precision, double d)
    {
        ...
        boolean[] signs = new boolean[1];            /* true if the sign bit was set in d */
...
//                DTOSTR_VARIABLE_BUFFER_SIZE(precision)));
        ...
        decPt = JS_dtoa(d, dtoaMode[mode], mode >= DTOSTR_FIXED, precision, signs, buffer);
